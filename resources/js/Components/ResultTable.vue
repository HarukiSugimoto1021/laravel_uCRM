...
<div v-if="data.type === 'rfm'"  class="table-auto w-full text-left whitespace-no-wrap">
    ...
    <table v-if="data.type === 'rfm'" class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
